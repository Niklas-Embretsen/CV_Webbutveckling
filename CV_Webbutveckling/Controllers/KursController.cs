...
namespace CV_Webbutveckling.Controllers
{
    public class KursController : Controller
    {
        ...
        public KursController(CV_WebbutvecklingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Namn,Kurskod,Ämne,Skola,Betyg,Beskrivning,Länk,DatumKursAvslutad")] Kurs kurs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Namn,Kurskod,Ämne,Skola,Betyg,Beskrivning,Länk,DatumKursAvslutad")] Kurs kurs)
        {
            if (id != kurs.Id)
            {
                return NotFound();
